    ...
    $("form#form").on("submit", function () {
        ...
        if ($(".requiredField").each(function () {
            if ("" === jQuery.trim($(this).val())) {
                ...
                var r = /^^(\\+33|0|0033)(1|2|3|4|5|6|7|9)[0-9]{8}$$/;
                ...
                var r =  /[-a-zA-Z0-9@:%._\+~#=]{1,256}\.[a-zA-Z0-9()]{1,6}\b([-a-zA-Z0-9()@:%_\+.~#?&//=]*)/;
                !r.test(jQuery.trim($(this).val())) || ($(this).prev("label").text(), $(this).parent().append('<span class="error">Texte invalide</span>'), $(this).addClass("inputError"), $('.contact-submit-button').prop('disabled', false), $('.contact-loader').prop('style', 'display:none;'), s = !0);
            }
        }), !s) {
            ...
            $.post($(this).attr("action"), r, function () {
                ...
                $("form#form").before('<div class="success contact-us-success">Merci pour votre message. Je vous réponds ' +
